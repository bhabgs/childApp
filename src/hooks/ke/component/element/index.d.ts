...
declare const getThingTextGroup: (out: Konva.Stage | Konva.Group, name?: keyof typeof groupNames) => konva_lib_Group.Group[];
...
declare const changeThingImage: (imageNode: Konva.Image, src: string, state: string) => Promise<unknown>;
